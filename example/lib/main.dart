...
class MapSampleState extends State<MapSample> {
  ...
  GoogleClusterManager _initClusterManager() {
    return GoogleClusterManager<Place>(items, _updateMarkers,
  ...
  Future<Marker> Function(GoogleCluster<Place>) get _markerBuilder =>
      (cluster) async {
        return Marker(
